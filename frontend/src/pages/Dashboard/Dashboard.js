...
function Dashboard() {
    return (
      <div className='dashboard'>
        ...
        <div className='article' aria-labelledby="article-summary">
        ...
        <div className='techStack' aria-labelledby="tech-summary">
